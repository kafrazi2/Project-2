...
fitLM <- train(shares ~ n_tokens_content + is_weekend, data = trainData, method = "lm", trControl = trainControl(method = "cv", number = 10))
fitLM 
...
### Commenting Out Until Above Question is Answered
n.trees <- 1:100
...
>>>>>>> 6f0f770add5d1bc2fa1f73d0c61f24cdbab9e1d2
