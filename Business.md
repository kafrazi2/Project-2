...
```
    ...
    ##    url        timedelta n_tokens_title n_tokens_content n_unique_tokens
    ##    <chr>          <dbl>          <dbl>            <dbl>           <dbl>
    ##  1 http://ma~       731              9              211           0.575
    ##  2 http://ma~       731             13              244           0.560
    ##  3 http://ma~       731              8              708           0.482
    ##  4 http://ma~       731             10              142           0.655
    ##  5 http://ma~       730             13              306           0.535
    ##  6 http://ma~       729             10              468           0.534
    ##  7 http://ma~       729              6              164           0.588
    ##  8 http://ma~       729             11              173           0.724
    ##  9 http://ma~       729              9              330           0.502
    ## 10 http://ma~       729             10              381           0.546
    ## # ... with 4,372 more rows, and 57 more variables:
    ## #   n_non_stop_words <dbl>, n_non_stop_unique_tokens <dbl>,
    ## #   num_hrefs <dbl>, num_self_hrefs <dbl>, num_imgs <dbl>,
    ## #   num_videos <dbl>, average_token_length <dbl>, num_keywords <dbl>,
    ## #   data_channel_is_lifestyle <dbl>,
...
```
    ...
    ##    url        timedelta n_tokens_title n_tokens_content n_unique_tokens
    ##    <chr>          <dbl>          <dbl>            <dbl>           <dbl>
    ##  1 http://ma~       731              9              255           0.605
    ##  2 http://ma~       731              8              397           0.625
    ##  3 http://ma~       731             11              723           0.491
    ##  4 http://ma~       731             12              444           0.601
    ##  5 http://ma~       731              6              109           0.667
    ##  6 http://ma~       729              9              759           0.499
    ##  7 http://ma~       729              9              233           0.553
    ##  8 http://ma~       729             10              424           0.553
    ##  9 http://ma~       728             10              347           0.517
    ## 10 http://ma~       728             16              487           0.520
    ## # ... with 1,866 more rows, and 57 more variables:
    ## #   n_non_stop_words <dbl>, n_non_stop_unique_tokens <dbl>,
    ## #   num_hrefs <dbl>, num_self_hrefs <dbl>, num_imgs <dbl>,
    ## #   num_videos <dbl>, average_token_length <dbl>, num_keywords <dbl>,
    ## #   data_channel_is_lifestyle <dbl>,
...
```
    ...
    ##  9 http://ma~       729              9              330           0.502
    ## 10 http://ma~       729             10              381           0.546
    ## # ... with 4,372 more rows, and 59 more variables:
    ## #   n_non_stop_words <dbl>, n_non_stop_unique_tokens <dbl>,
    ## #   num_hrefs <dbl>, num_self_hrefs <dbl>, num_imgs <dbl>,
    ## #   num_videos <dbl>, average_token_length <dbl>, num_keywords <dbl>,
    ## #   data_channel_is_lifestyle <dbl>,
...
![](Business_files/figure-gfm/EDA1-1.png)<!-- -->
...
![](Business_files/figure-gfm/EDA%202-1.png)<!-- -->
...
```
    ...
    ##   <fct>      <dbl> <dbl>  <dbl> <dbl>
    ## 1 0              1  1300 652900 2929.
    ## 2 1            150  2500 144400 4037.
...
```
    ...
    ##   3   5  33 101 260 533 688 784 757 567 346 187  84  25   6   2   1
...
![](Business_files/figure-gfm/EDA%203-1.png)<!-- -->
...
```
    ...
    ##   <chr>                <dbl>      <dbl>     <dbl>
    ## 1 Friday               2290.       1400     4361.
    ## 2 Monday               3649.       1400    23601.
    ## 3 Saturday             4904.       2700    11955.
    ## 4 Sunday               3462.       2200     4340.
    ## 5 Thursday             3174.       1300    15414.
    ## 6 Tuesday              2782.       1300     6923.
    ## 7 Wednesday            2593.       1300     8011.
...
![](Business_files/figure-gfm/EDA%205-1.png)<!-- -->
...
```
    ...
    ##   <fct>             <dbl>      <dbl>     <dbl>
    ## 1 (0,10]            2431.       1400     5066.
    ## 2 (10,20]           6060.       2150    26533.
    ## 3 (20,40]          13860.       1500    58454.
    ## 4 (40,51]           1500        1500       NA 
    ## 5 <NA>              5970.       1400    31139.
...
![](Business_files/figure-gfm/EDA%207-1.png)<!-- -->
...
![](Business_files/figure-gfm/EDA%208-1.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 3944, 3944, 3943, 3944, 3944, 3944, ... 
    ## Resampling results:
    ## 
    ##   RMSE      Rsquared     MAE     
    ##   10510.39  0.004757362  2669.599
    ## 
...
```
    ...
    ## No pre-processing
    ## Resampling: Cross-Validated (10 fold) 
    ## Summary of sample sizes: 3944, 3944, 3944, 3944, 3944, 3942, ... 
    ## Resampling results:
    ## 
    ##   RMSE      Rsquared     MAE     
    ##   10124.68  0.003578414  2712.194
    ## 
    ## Tuning parameter 'intercept' was held constant at a value of TRUE
...
```
    ...
    ## Resampling: Cross-Validated (10 fold) 
    ## Summary of sample sizes: 3944, 3945, 3944, 3943, 3943, 3944, ... 
    ## Resampling results:
    ## 
    ##   RMSE      Rsquared    MAE     
    ##   10488.95  0.01067003  2684.151
    ## 
    ## Tuning parameter 'intercept' was held constant at a value of TRUE
...
```
    ...
    ## Summary of sample sizes: 3506, 3505, 3506, 3506, 3505 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  RMSE      Rsquared     MAE     
    ##   1     11891.42  0.010465408  2666.313
    ##   2     12144.40  0.007896754  2684.302
    ##   3     12429.05  0.007549101  2717.067
    ##   4     12775.22  0.006929914  2779.598
    ## 
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 1.829744e+04 8.807110e-04 2.289314e+03
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 1.828140e+04 2.050436e-05 2.810490e+03
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 1.825641e+04 2.362166e-03 2.842232e+03
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 1.817504e+04 1.821514e-02 2.791584e+03
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 1.827863e+04 1.493896e-06 2.818807e+03
